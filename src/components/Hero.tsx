...
export default function Hero() {
  return (
    <section id="top" className="hero-section" aria-labelledby="hero-title">
      <div className="hero-microcopy top-left">MOOC AI LAB / 2026<br /><span>HUMAN <b>x</b> AI</span></div>
      ...
      <div className="hero-copy">
        ...
        <span className="hero-wordmark" aria-hidden="true">MOOC<br />AI LAB<br />2026</span>
      ...
      <div className="hero-index">[ 01 ]<br />MOOC<br />AI DEPARTMENT</div>
